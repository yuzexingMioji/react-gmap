...
var api = (window.apiConfig && window.apiConfig[window.location.hostname] && window.apiConfig[window.location.hostname].php || window.apiConfig.localhost.php) + ADDRESS;
