...
var InfoMap = function (_Component) {
  ...
  InfoMap.prototype.createContent = function createContent(data) {
    ...
    content.innerHTML = "<img class='gmap-info-map-img' src=" + imageUrl + " />" + "<div class='map-info-wrap'>" + "<span class='gmap-info-map-first-title over-hide " + style.extraCool + "'>" + first + "</span>" + "<span class='gmap-info-map-second-title over-hide " + style.extraCooler + "'>" + second + "</span>" + "<span class='gmap-info-map-third-title over-hide " + style.extraCoolest + "'>" + third + "</span>" + "</div>" + "<div class='gmap-info-map-btn-wrap " + style.icon + "' id='btn-option'>" + icon + "</div>";
