...
var InfoMap = function (_Component) {
  ...
  InfoMap.prototype.createContent = function createContent(data) {
    ...
    content.innerHTML = "<img class='map-img' src=" + imageUrl + " />" + "<div class='map-info-wrap'>" + "<span class='first-title over-hide " + style.extraCool + "'>" + first + "</span>" + "<span class='second-title over-hide " + style.extraCooler + "'>" + second + "</span>" + "<span class='third-title over-hide " + style.extraCoolest + "'>" + third + "</span>" + "</div>" + "<div class='btn-wrap " + style.icon + "' id='btn-option'>" + icon + "</div>";
